...
class LoadScreenshots:
    ...
    def __next__(self):
        ...
        if self.transforms:
            ...
            im = letterbox(im0, self.img_size, stride=self.stride, auto=self.auto)[0]  # padded resize # (640, 480, 3) if orginal one is 彩色 810*1080
...
class LoadImages:
    ...
    def __init__(self, path, img_size=640, stride=32, auto=True, transforms=None, vid_stride=1):
        ...
        images = [x for x in files if x.split(".")[-1].lower() in IMG_FORMATS]  # 遍历输入 有没有img格式的
        videos = [x for x in files if x.split(".")[-1].lower() in VID_FORMATS]  # 遍历输入 有没有视频格式的
